    ...
    <div className="px-16 py-5 h-screen mb-[800px]">
      <div>
        <div className="flex gap-96 items-start first-pd-cr">
          <div>
            <h1 className="text-xl font-bold title-pd">
        ...
        <div className="grid grid-cols-12 mt-5 gap-5">
          <div className="col-span-12 md:col-span-8">
            <img
              ...
              src="https://i.postimg.cc/L8LGrt1Y/3c0e5032c3804cfd35f9242b710af66c.jpg"
              alt=""
            />
            <div className="flex justify-between mt-5 max-w-[800px] pd-img">
              <img
                className="w-[290px] h-[160px] pd-img-1"
              ...
              <div className="relative">
                <img
                  className="w-[188px] h-[160px] pd-img-1"
          ...
          <div className="col-span-12 md:col-span-4 mx-auto">
            <div className=" w-[385px] h-[492px] bg-[#ECF5FF] p-5">
              ...
              <p className="text-xl font-bold mt-5">$ 300k - $ 310k</p>
              <p className="my-5">
      ...
      <div className="bg-slate-50 border p-4 mb-10">
        ...
        <div className="flex flex-col gap-5">
          <img
            className="mx-auto"
            src="https://i.postimg.cc/Qxy2pWNn/Frame-154-1.png"
            alt=""
          />
          <img
            className="mx-auto"
            src="https://i.postimg.cc/SN1nCVMF/Frame-155-1.png"
            alt=""
          />
          <img
            className="mx-auto"
            src="https://i.postimg.cc/x8rWWwhD/Frame-156-1.png"
            alt=""
          />
          <img
            className="mx-auto"
            src="https://i.postimg.cc/rpK3zyL2/Frame-157.png"
            alt=""
          />
          <img
            className="mx-auto"
            src="https://i.postimg.cc/rFjPJRVL/Frame-158-1.png"
            alt=""
          />
        </div>
      </div>
